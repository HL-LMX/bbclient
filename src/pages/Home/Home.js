	...
	export const Home = () => {
		...
		<div className="container">
			...
			<h3 className="card-title text-center m-5">Version 1.2</h3>
			...
			<div className="col-md-10 card bg-light">
				...
				<div className="col-md-6">
					...
					<div className="card-body m-3 text-center">
						<p className="card-text" style={{ fontSize: '1.5em', textAlign: 'left' }}>
						On this site, you can:
						</p>
						<ul>
						<li className="list-group-item" style={{ fontSize: '1.2em', textAlign: 'left' }}>1. Check the menu</li>
						<li className="list-group-item" style={{ fontSize: '1.2em', textAlign: 'left' }}>2. Book your visit</li>
						<li className="list-group-item" style={{ fontSize: '1.2em', textAlign: 'left' }}>3. Rate the food!</li>
						</ul>
					</div>
					</div>
				</div>
